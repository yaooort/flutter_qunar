package com.yaooort.baidu_asr.baidu_ai;
...
import com.yaooort.baidu_asr.baidu_ai.listener.RecogEventAdapter;
...
public class MyRecognizer {
    ...
    private static final String TAG = "com.example.asr_plugin.baidu_ai.MyRecognizer";
